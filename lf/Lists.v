...
(*   match l1, l2 with
  ...
  | nil, n :: _ => false
  | n :: _, nil => false
  | n1 :: l1', n2 :: l2' => if n1 =? n2 then eqblist l1 l2
                            else false
  end. *)
  match l1 with
  | nil => match l2 with
  ...
  | n1 :: l1' => match l2 with
                 | nil => false
                 | n2 :: l2'  => if n1 =? n2 then eqblist l1' l2'
                                 else false
                 end
  end.
...
Proof.
  ...
  - simpl. 
    rewrite -> IHs1'.
    assert (if_else_plus: forall (b:bool) (t:nat) (e:nat) (x:nat), 
